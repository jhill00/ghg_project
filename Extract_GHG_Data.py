...
# function that creates a csv file and is non-blocking
# if the file name does not exist, create file, else append to existing file
async def create_file(session, url: str):
    ...
    # checks if the file exists (if the file is not in this path..)
...
async def main():
    ...
    async with aiohttp.ClientSession() as session:
        ...
        await asyncio.gather(*save_csv_tasks) # returns a list of csv data
